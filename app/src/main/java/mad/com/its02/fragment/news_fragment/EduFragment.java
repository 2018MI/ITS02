...
public class EduFragment extends Fragment {
    ...
    private View mView;
    private ListView mFrgNewsEduLvContainer;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_edu, container, false);
        initView();
        return mView;
    }

    private void initView() {
        mFrgNewsEduLvContainer = (ListView) mView.findViewById(R.id.frg_news_edu_lv_container);
        initLv();
    }
    ...
    private void initLv() {
        ...
        mFrgNewsEduLvContainer.setAdapter(mAdapter);
    }
